...
// void ipc::travel_monitor::setup::receive_bloom_filters(travelMonitorIndex* tm_index, const structures::CommunicationPipes pipes[])
// {
...
//         ipc::travel_monitor::setup::_receive_bloom_filters(tm_index, input_fds[ready_monitor], output_fds[ready_monitor]);
...
// void ipc::monitor::setup::send_bloom_filters(MonitorIndex* m_index, const structures::CommunicationPipes* pipes)
// {
