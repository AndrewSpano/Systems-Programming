...
typedef enum communicationID
{
    ...
    ADD_VACCINATION_RECORDS_SEND_DATA = 12,
    ADD_VACCINATION_RECORDS_OK = 13,
    SEARCH_VACCINATION_STATUS_SEND_DATA = 14,
    SEARCH_VACCINATION_STATUS_DOES_NOT_CONTAIN = 15,
    SEARCH_VACCINATION_STATUS_CONTAINS = 16,
    SEARCH_VACCINATION_STATUS_DATA = 17,
    EXIT = 18
} communicationID;
